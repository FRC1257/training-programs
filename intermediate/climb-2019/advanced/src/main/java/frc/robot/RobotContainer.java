...
import frc.robot.commands.climb.ClimbAdvanceCommand;
import frc.robot.commands.climb.ClimbBackCommand;
import frc.robot.commands.climb.ClimbDriveCommand;
...
public class RobotContainer {
    ...
    private void configureSubsystems() {
        climb = new Climb();
        climb.setDefaultCommand(new ClimbDriveCommand(climb, operatorController::getLeftY));
    ...
    private void configureButtonBindings() {
        operatorController.getButton(Button.kA.value).whenPressed(new ClimbAdvanceCommand(climb), false);
        operatorController.getButton(Button.kB.value).whenPressed(new ClimbBackCommand(climb), false);
    }
