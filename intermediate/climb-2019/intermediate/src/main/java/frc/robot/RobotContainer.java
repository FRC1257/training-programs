...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        operatorController.getButton(Button.kA.value).whenPressed(new ClimbAdvanceCommand(climb));
        operatorController.getButton(Button.kB.value).whenPressed(new ClimbBackCommand(climb));
    }
