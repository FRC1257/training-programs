...
import frc.robot.commands.elevator.ElevatorTogglePrecision;
...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        operatorController.getButton(Button.kY.value).whenPressed(new ElevatorTogglePrecision(elevator));
    }
