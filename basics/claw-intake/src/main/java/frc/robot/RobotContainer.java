...
import frc.robot.commands.clawintake.ClawIntakeCloseCommand;
import frc.robot.commands.clawintake.ClawIntakeOpenCommand;
...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        operatorController.getButton(Button.kA.value).whenPressed(new ClawIntakeOpenCommand(clawIntake));
        operatorController.getButton(Button.kB.value).whenPressed(new ClawIntakeCloseCommand(clawIntake));   
    }
