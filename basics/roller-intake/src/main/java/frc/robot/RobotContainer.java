...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        operatorController.getButton(Button.kB.value).whileActiveOnce(new RollerIntakeIntakeCommand(rollerIntake));
        operatorController.getButton(Button.kA.value).whileActiveOnce(new RollerIntakeEjectCommand(rollerIntake));
    }
